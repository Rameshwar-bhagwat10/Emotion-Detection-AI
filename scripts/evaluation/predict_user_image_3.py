"""Evaluate emotion detection model on third user uploaded photo."""
...
def run_prediction():
    img_path = Path(r"C:\Users\RAMESHWAR\.gemini\antigravity-ide\brain\30f8f558-1cdd-47d4-9754-31cef0de6c48\.user_uploaded\media_1787462528908.jpg")
    ...
    print("=" * 65)
    print("EMOTION DETECTION INFERENCE RESULT FOR THIRD UPLOADED PHOTO")
    print("=" * 65)
    ...
    save_preview_path = Path("reports/random_and_internet_eval/uploaded_user_face_crop_3.png")
